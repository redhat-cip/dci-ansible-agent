...
install -p -D -m 644 hooks/tests.yml %{buildroot}%{_sysconfdir}/dci-ansible-agent/hooks/tests.yml
...
%config(noreplace) %{_sysconfdir}/dci-ansible-agent/hooks/tests.yml
