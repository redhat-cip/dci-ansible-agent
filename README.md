...
### How to use the images (OSP12 and Pike)

If you are use OSP12 or Pike, you need to adjust your automation to fetch the images on the undercloud and make use of them during the deployment.
